<button type="button"
        x-bind:class="darkMode ? 'bg-primary-50' : 'bg-gray-200'" x-on:click="darkMode = !darkMode" class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-50 focus:ring-offset-2" role="switch" aria-checked="false">
