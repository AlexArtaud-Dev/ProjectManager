...
<button x-on:click="darkMode = !darkMode" class="fixed bottom-0 right-0 m-4 px-4 py-2 rounded-full bg-gray-100 dark:bg-background-700 border border-gray-200 dark:border-background-700 shadow-lg">
